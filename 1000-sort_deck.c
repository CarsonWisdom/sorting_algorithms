 ...
 *@str1: string
 *@str2: string
 *Return: 1 str1 ad str2 is equal, 0 they are not equal
 */
...
/**
 * get_card_position - return position based on card you put in
...
/**
 * insertion_sort_deck - function that sorts a doubly linked
